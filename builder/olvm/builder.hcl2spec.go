...
type FlatConfig struct {
	...
	SourceDiskURL                  *string           `mapstructure:"source_disk_url" cty:"source_disk_url" hcl:"source_disk_url"`
	SourceDiskURLChecksum          *string           `mapstructure:"source_disk_url_checksum" cty:"source_disk_url_checksum" hcl:"source_disk_url_checksum"`
	SourceDiskChecksumURL          *string           `mapstructure:"source_disk_checksum_url" cty:"source_disk_checksum_url" hcl:"source_disk_checksum_url"`
	SourceDiskURLChecksumType      *string           `mapstructure:"source_disk_url_checksum_type" cty:"source_disk_url_checksum_type" hcl:"source_disk_url_checksum_type"`
	SourceDiskUploadName           *string           `mapstructure:"source_disk_upload_name" cty:"source_disk_upload_name" hcl:"source_disk_upload_name"`
	SourceDiskStorageDomain        *string           `mapstructure:"source_disk_storage_domain" cty:"source_disk_storage_domain" hcl:"source_disk_storage_domain"`
	ForceUpload                    *bool             `mapstructure:"force_upload" cty:"force_upload" hcl:"force_upload"`
	ConvertRawSparseToPreallocated *bool             `mapstructure:"convert_raw_sparse_to_preallocated" cty:"convert_raw_sparse_to_preallocated" hcl:"convert_raw_sparse_to_preallocated"`
	...
	VMFirmwareType                 *string           `mapstructure:"vm_firmware_type" cty:"vm_firmware_type" hcl:"vm_firmware_type"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"source_disk_url":                    &hcldec.AttrSpec{Name: "source_disk_url", Type: cty.String, Required: false},
		"source_disk_url_checksum":           &hcldec.AttrSpec{Name: "source_disk_url_checksum", Type: cty.String, Required: false},
		"source_disk_checksum_url":           &hcldec.AttrSpec{Name: "source_disk_checksum_url", Type: cty.String, Required: false},
		"source_disk_url_checksum_type":      &hcldec.AttrSpec{Name: "source_disk_url_checksum_type", Type: cty.String, Required: false},
		"source_disk_upload_name":            &hcldec.AttrSpec{Name: "source_disk_upload_name", Type: cty.String, Required: false},
		"source_disk_storage_domain":         &hcldec.AttrSpec{Name: "source_disk_storage_domain", Type: cty.String, Required: false},
		"force_upload":                       &hcldec.AttrSpec{Name: "force_upload", Type: cty.Bool, Required: false},
		"convert_raw_sparse_to_preallocated": &hcldec.AttrSpec{Name: "convert_raw_sparse_to_preallocated", Type: cty.Bool, Required: false},
		...
		"vm_firmware_type":                   &hcldec.AttrSpec{Name: "vm_firmware_type", Type: cty.String, Required: false},
